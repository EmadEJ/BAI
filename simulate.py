...
def simulate(verbose=True):
    ...
    n, k, delta, means, contexts, w_star, T_stars = read_instance_from_json(instance_path)
    ...
    env = Environment(means, args.Algorithm, n, k, delta, contexts, mode=mode, stopping_rule=args.stopping_rule)
